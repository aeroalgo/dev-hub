...
## load_now
1. [back/plan/T-HUB-083-role-core-shared-contract/yaml/steps/s01-role-core-contract-red-tests.yaml](back/plan/T-HUB-083-role-core-shared-contract/yaml/steps/s01-role-core-contract-red-tests.yaml) — текущий work shard (BACK IMPLEMENT s01).
...
- **Текущий шаг:** s01 — Semantic corpus устанавливает common-owner и role-guard failure matrix (status=pending в index.yaml).
