...
→ decompose-index: [yaml/decompose-index.yaml](../yaml/decompose-index.yaml) · machine [../yaml/decompose-index.yaml](../yaml/decompose-index.yaml) — **sole tracker** (не дублировать чеклист шагов в этом плане).
