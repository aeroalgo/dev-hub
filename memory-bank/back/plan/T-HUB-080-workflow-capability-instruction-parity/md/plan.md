...
| BACK modes | `harness/cursor/rules/back_developer/workflow-implement.mdc`; `harness/cursor/rules/back_developer/workflow-task.mdc`; `harness/cursor/rules/back_developer/workflow-bugfix.mdc`; `harness/cursor/rules/back_developer/workflow-qa.mdc`; `harness/cursor/rules/back_developer/mainrule-core.mdc`; `harness/cursor/rules/back_developer/isolation_rules/_lean/implement.mdc`; `harness/cursor/rules/back_developer/isolation_rules/_lean/task.mdc`; `harness/cursor/rules/back_developer/isolation_rules/_lean/bugfix.mdc`; `harness/cursor/rules/back_developer/isolation_rules/_lean/qa.mdc` | Rewrite action lines with explicit hub/managed branches; leave negative/forbidden checks intact; keep QA full-suite distinction. |
| INTEG modes | `harness/cursor/rules/integration_developer/workflow-implement.mdc`; `harness/cursor/rules/integration_developer/workflow-qa.mdc`; `harness/cursor/rules/integration_developer/mainrule-core.mdc`; `harness/cursor/rules/integration_developer/isolation_rules/_lean/implement.mdc`; `harness/cursor/rules/integration_developer/isolation_rules/_lean/bugfix.mdc`; `harness/cursor/rules/integration_developer/isolation_rules/_lean/qa.mdc` | Separate hub HTTP pytest scenario from managed capability evidence; preserve UI scenario and parent-only browser rule. |
...
| Artifact templates | `harness/cursor/templates/plan.md`; `harness/cursor/templates/decompose/epic-step.yaml`; `harness/cursor/templates/decompose/legacy-purge-step.yaml`; `harness/cursor/templates/implement/epic-step.yaml`; `harness/cursor/templates/qa/epic-step.yaml`; `harness/cursor/templates/integration-plan.md`; `harness/cursor/templates/refactor/epic-step.yaml`; `harness/cursor/templates/security/epic-step.yaml`; `harness/cursor/templates/finish-doc-router.md` | Mark direct examples hub-only or replace managed examples with `capability_checks`/evidence; retain executable format requirements. |
