...
| **s07** | [s07-legacy-fallback-purge.yaml](../yaml/steps/s07-legacy-fallback-purge.yaml) | [s07…](../../implement/T-HUB-086-python-loop-supervisor-cutover/s07-legacy-fallback-purge.yaml) | no | yes | BACK IMPLEMENT | pending |
