...
→ [T-HUB-045-harness-workflow-session-load-api/yaml/decompose-index.yaml](T-HUB-045-harness-workflow-session-load-api/yaml/decompose-index.yaml) — **после DECOMPOSE**
