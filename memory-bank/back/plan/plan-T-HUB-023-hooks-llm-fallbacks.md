...
→ **BACK DECOMPOSE** (re-run после plan v4) · prior decompose invalid · coverage: [decompose-T-HUB-023-hooks-llm-fallbacks/](decompose-T-HUB-023-hooks-llm-fallbacks/) — **создать заново из §Decompose input map**
...
> Трекер после DECOMPOSE: [decompose-T-HUB-023-hooks-llm-fallbacks/index.yaml](decompose-T-HUB-023-hooks-llm-fallbacks/index.yaml)
...
Трекер после BACK DECOMPOSE: [decompose-T-HUB-023-hooks-llm-fallbacks/index.yaml](decompose-T-HUB-023-hooks-llm-fallbacks/index.yaml)
