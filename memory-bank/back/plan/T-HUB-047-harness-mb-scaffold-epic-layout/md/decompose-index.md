...
**Plan:** [plan/T-HUB-047-harness-mb-scaffold-epic-layout/md/plan.md](../plan/T-HUB-047-harness-mb-scaffold-epic-layout/md/plan.md)  
...
| **s02** | loop/paths/epic_layout.py resolver — единственный path API · [yaml](s02-epic-layout-resolver.yaml) | BACK IMPLEMENT | completed |
| **s03** | loop/mb_scaffold/ — scaffold_plan, scaffold_decompose, scaffold_implement_all, scaffold_qa, scaffold_analyze, scaffold_audit · [yaml](s03-mb-scaffold-core.yaml) | BACK IMPLEMENT | completed |
| **s04** | epic_resolve.py mb-scaffold subparser — plan/decompose/implement/qa/analyze/audit · [yaml](s04-mb-scaffold-cli.yaml) | BACK IMPLEMENT | completed |
| **s05** | loop/migrate/epic_layout_v1_to_v2.py — flat→v2 migrate (--dry-run/--apply) · [yaml](s05-migrate-script.yaml) | BACK IMPLEMENT | completed |
| **s06** | Harness integration — epic_paths.py thin wrapper + _lib.py/reconcile.py/seed_implement/mb_finish resolver wire · [yaml](s06-harness-resolver-wire.yaml) | BACK IMPLEMENT | completed |
