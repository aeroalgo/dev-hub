...
| **s05** | [s05-role-core-semantic-regression.yaml](../yaml/steps/s05-role-core-semantic-regression.yaml) — mode-W matrix and full suite evidence | [s05…](../../implement/T-HUB-083-role-core-shared-contract/s05-role-core-semantic-regression.yaml) | no | yes | BACK IMPLEMENT | completed |
