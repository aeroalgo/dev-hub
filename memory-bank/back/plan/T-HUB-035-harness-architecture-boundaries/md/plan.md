...
→ [T-HUB-035-harness-architecture-boundaries/yaml/decompose-index.yaml](T-HUB-035-harness-architecture-boundaries/yaml/decompose-index.yaml) — **после DECOMPOSE**
