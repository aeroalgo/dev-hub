...
→ [T-HUB-050-workflow-pack-memory-bank-paths/yaml/decompose-index.yaml](T-HUB-050-workflow-pack-memory-bank-paths/yaml/decompose-index.yaml) — **после DECOMPOSE**
