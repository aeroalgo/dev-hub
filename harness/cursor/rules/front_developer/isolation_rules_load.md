# Isolation — каталог FRONT (не грузить целиком)

**На команде:** читай **только** `_lean/<mode>.mdc` из шага `1a` / **Gates** в `workflow-*.mdc`.  
Скиллы — только из workflow.

База: `.cursor/rules/front_developer/isolation_rules/_lean/`  
