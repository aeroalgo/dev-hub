...
> **Policy:** статус шага здесь не хранить. Статус — в `implement/<epic_id>/aNN-*.yaml` (`epic-security/v1`) и `yaml/decompose-index.yaml`.
...
- **Produces:** `security/implement/<id>/aNN-<slug>.yaml` — findings + severity + evidence
