...
description: "Coverage-semantic agent for DECOMPOSE. Reads plan + decompose index/shards from ALLOW READ. Parent packs paths only — no COVERAGE/PLAN EXCERPT prompt. Never edits; no pytest."
