...
def test_finish_decompose_v2_resolver_path(tmp_path: Path):
    ...
    decomp_step.write_text(
        ...
        f"next_phase: BACK IMPLEMENT\n"
        f"skills:\n"
        f"  code_surface: infra\n"
        f"  impl:\n"
        f"    - .agents/skills/tdd/SKILL.md\n"
        f"    - .agents/skills/python-testing-patterns/SKILL.md\n"
        f"    - .agents/skills/modern-python/SKILL.md\n"
        f"    - .agents/skills/python-anti-patterns/SKILL.md\n"
        f"as_built: []\n"
        f"plan_contract:\n"
        f"  fr_ids: [FR-01]\n"
        f"  nouns: [noun-1]\n"
